...
create_gems (void)
{
	...
	gtk_toolbar_append_element (GTK_TOOLBAR (toolbar1),
				    ...
				    _("Next"), NULL, tmp_toolbar_icon, NULL,
				    NULL);
...
static GnomeUIInfo menu1_uiinfo[] = {
    {
     ...
     NULL,
     on_create1_activate, NULL, NULL,
     GNOME_APP_PIXMAP_NONE, NULL,
     0, 0, NULL},
    {
     GNOME_APP_UI_ITEM, N_("Open"),
     NULL,
     on_open2_activate, NULL, NULL,
     GNOME_APP_PIXMAP_NONE, NULL,
     0, 0, NULL},
    {
...
create_compose (void)
{
    ...
    gtk_object_set_data_full (GTK_OBJECT (compose), "optionmenu1",
			      optionmenu1,
			      (GtkDestroyNotify) gtk_widget_unref);
...
create_delete_mbox (void)
{
    ...
    gtk_object_set_data (GTK_OBJECT (delete_mbox), "delete_mbox",
			 delete_mbox);
    ...
    button9 = g_list_last (GNOME_DIALOG (delete_mbox)->buttons)->data;
    ...
    button11 = g_list_last (GNOME_DIALOG (delete_mbox)->buttons)->data;
...
create_create_mbox (void)
{
    ...
    gtk_object_set_data (GTK_OBJECT (create_mbox), "create_mbox",
			 create_mbox);
    ...
    gnome_dialog_append_button (GNOME_DIALOG (create_mbox),
				GNOME_STOCK_BUTTON_OK);
    button12 = g_list_last (GNOME_DIALOG (create_mbox)->buttons)->data;
    ...
    button13 = g_list_last (GNOME_DIALOG (create_mbox)->buttons)->data;
    ...
    gnome_dialog_append_button (GNOME_DIALOG (create_mbox),
				GNOME_STOCK_BUTTON_CANCEL);
    button14 = g_list_last (GNOME_DIALOG (create_mbox)->buttons)->data;
...
create_Rules (void)
{
	...
	gtk_toolbar_append_element (GTK_TOOLBAR (toolbar3),
				    GTK_TOOLBAR_CHILD_BUTTON, NULL, _("Up"),
				    NULL, NULL, tmp_toolbar_icon, NULL, NULL);
    ...
    button22 =
	gtk_toolbar_append_element (GTK_TOOLBAR (toolbar3),
				    GTK_TOOLBAR_CHILD_BUTTON, NULL, _("Down"),
				    NULL, NULL, tmp_toolbar_icon, NULL, NULL);
    ...
    gtk_object_set_data_full (GTK_OBJECT (Rules), "combo_entry2",
			      combo_entry2,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    button15 = g_list_last (GNOME_DIALOG (Rules)->buttons)->data;
    ...
    gnome_dialog_append_button (GNOME_DIALOG (Rules),
				GNOME_STOCK_BUTTON_APPLY);
    button16 = g_list_last (GNOME_DIALOG (Rules)->buttons)->data;
    ...
    gnome_dialog_append_button (GNOME_DIALOG (Rules),
				GNOME_STOCK_BUTTON_CANCEL);
    button17 = g_list_last (GNOME_DIALOG (Rules)->buttons)->data;
