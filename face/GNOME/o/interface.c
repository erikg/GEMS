...
create_gems (void)
{
	...
	"toolbar1", GNOME_DOCK_ITEM_BEH_EXCLUSIVE, GNOME_DOCK_TOP, 1, 0, 0);
	...
	GTK_TOOLBAR_CHILD_BUTTON, NULL, _("Compose"), _("Compose"), NULL,
	tmp_toolbar_icon, NULL, NULL);
    gtk_widget_ref (toolbar_compose);
    gtk_object_set_data_full (GTK_OBJECT (gems), "toolbar_compose",
	toolbar_compose, (GtkDestroyNotify) gtk_widget_unref);
    ...
    toolbar_reply =
	gtk_toolbar_append_element (GTK_TOOLBAR (toolbar1),
	GTK_TOOLBAR_CHILD_BUTTON, NULL, _("Reply"), _("Reply"), NULL,
	tmp_toolbar_icon, NULL, NULL);
    gtk_widget_ref (toolbar_reply);
    gtk_object_set_data_full (GTK_OBJECT (gems), "toolbar_reply",
	toolbar_reply, (GtkDestroyNotify) gtk_widget_unref);
    ...
    toolbar_forward =
	gtk_toolbar_append_element (GTK_TOOLBAR (toolbar1),
	GTK_TOOLBAR_CHILD_BUTTON, NULL, _("Forward"), _("Forward"), NULL,
	tmp_toolbar_icon, NULL, NULL);
    gtk_widget_ref (toolbar_forward);
    gtk_object_set_data_full (GTK_OBJECT (gems), "toolbar_forward",
	toolbar_forward, (GtkDestroyNotify) gtk_widget_unref);
    ...
    toolbar_prev =
	gtk_toolbar_append_element (GTK_TOOLBAR (toolbar1),
	GTK_TOOLBAR_CHILD_BUTTON, NULL, _("Previous"), _("Previous"), NULL,
	tmp_toolbar_icon, NULL, NULL);
    ...
    toolbar_next =
	gtk_toolbar_append_element (GTK_TOOLBAR (toolbar1),
	GTK_TOOLBAR_CHILD_BUTTON, NULL, _("Next"), _("Next"), NULL,
	tmp_toolbar_icon, NULL, NULL);
    ...
    tmp_toolbar_icon =
	gnome_stock_pixmap_widget (gems, GNOME_STOCK_PIXMAP_BOOK_RED);
    toolbar_rule =
	gtk_toolbar_append_element (GTK_TOOLBAR (toolbar1),
	GTK_TOOLBAR_CHILD_BUTTON, NULL, _("Rules"), _("Rules"), NULL,
	tmp_toolbar_icon, NULL, NULL);
    ...
    gtk_object_set_data_full (GTK_OBJECT (gems), "scrolledwindow5",
    ...
    gtk_object_set_data_full (GTK_OBJECT (gems), "scrolledwindow3",
	scrolledwindow3, (GtkDestroyNotify) gtk_widget_unref);
	...
	GTK_SIGNAL_FUNC (on_gems_quit), NULL);
	...
	GTK_SIGNAL_FUNC (on_toolbar_prev_clicked), NULL);
	...
	GTK_SIGNAL_FUNC (on_toolbar_rule_clicked), NULL);
    gtk_signal_connect (GTK_OBJECT (ctree2), "tree_select_row",
	GTK_SIGNAL_FUNC (on_ctree2_tree_select_row), NULL);
    gtk_signal_connect (GTK_OBJECT (ctree2), "event",
	GTK_SIGNAL_FUNC (on_mboxlist_event), NULL);
    gtk_signal_connect (GTK_OBJECT (ctree2), "key_press_event",
	GTK_SIGNAL_FUNC (on_mboxlist_keyevent), NULL);
    gtk_signal_connect (GTK_OBJECT (ctree1), "event",
	GTK_SIGNAL_FUNC (on_ctree1_event), NULL);
    gtk_signal_connect (GTK_OBJECT (ctree1), "key_press_event",
	GTK_SIGNAL_FUNC (on_ctree1_key_press_event), NULL);
    gtk_signal_connect (GTK_OBJECT (ctree1), "click_column",
	GTK_SIGNAL_FUNC (on_ctree1_click_column), NULL);
...
create_about2 (void)
{
	...
	_("Copyright (C) 2000 Erik Greenwald"), authors, "", NULL);
...
create_compose (void)
{
    ...
    tmp_toolbar_icon =
	gnome_stock_pixmap_widget (compose, GNOME_STOCK_PIXMAP_MAIL_SND);
    button6 =
	gtk_toolbar_append_element (GTK_TOOLBAR (toolbar2),
	GTK_TOOLBAR_CHILD_BUTTON, NULL, _("Send"), NULL, NULL,
	tmp_toolbar_icon, NULL, NULL);
    ...
    tmp_toolbar_icon =
	gnome_stock_pixmap_widget (compose, GNOME_STOCK_PIXMAP_SPELLCHECK);
    button7 =
	gtk_toolbar_append_element (GTK_TOOLBAR (toolbar2),
	GTK_TOOLBAR_CHILD_BUTTON, NULL, _("button7"), NULL, NULL,
	tmp_toolbar_icon, NULL, NULL);
	...
	NULL, _("button8"), NULL, NULL, NULL, NULL, NULL);
    ...
    gtk_object_set_data_full (GTK_OBJECT (compose), "combo_entry1",
	combo_entry1, (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (compose), "scrolledwindow6",
...
create_delete_mbox (void)
{
    ...
    gtk_object_set_data (GTK_OBJECT (delete_mbox), "dialog_vbox1",
	dialog_vbox1);
    ...
    gtk_object_set_data (GTK_OBJECT (delete_mbox), "dialog_action_area1",
	dialog_action_area1);
    ...
    gnome_dialog_append_button (GNOME_DIALOG (delete_mbox),
	GNOME_STOCK_BUTTON_OK);
    button9 =
	GTK_WIDGET (g_list_last (GNOME_DIALOG (delete_mbox)->buttons)->data);
	...
	GTK_SIGNAL_FUNC (on_mailboxdeleteok_clicked), NULL);
    gtk_signal_connect (GTK_OBJECT (button11), "clicked",
	GTK_SIGNAL_FUNC (on_mailboxdeletecancel_clicked), NULL);
...
create_create_mbox (void)
{
    ...
    gtk_object_set_data (GTK_OBJECT (create_mbox), "dialog_vbox2",
	dialog_vbox2);
    ...
    label14 =
	gtk_label_new (_
	("Please enter the name of the mailbox\nyou want to create\n"));
    ...
    gtk_object_set_data (GTK_OBJECT (create_mbox), "dialog_action_area2",
	dialog_action_area2);
    ...
    gnome_dialog_append_button (GNOME_DIALOG (create_mbox),
	GNOME_STOCK_BUTTON_OK);
    button12 =
	GTK_WIDGET (g_list_last (GNOME_DIALOG (create_mbox)->buttons)->data);
	...
	GTK_SIGNAL_FUNC (on_mailboxcreateok_clicked), NULL);
    gtk_signal_connect (GTK_OBJECT (button13), "clicked",
	GTK_SIGNAL_FUNC (on_mailboxcreateapply_clicked), NULL);
    gtk_signal_connect (GTK_OBJECT (button14), "clicked",
	GTK_SIGNAL_FUNC (on_mailboxcreatecancel_clicked), NULL);
...
create_Rules (void)
{
    ...
    gtk_object_set_data_full (GTK_OBJECT (Rules), "scrolledwindow7",
    ...
    tmp_toolbar_icon =
	gnome_stock_pixmap_widget (Rules, GNOME_STOCK_PIXMAP_UP);
    button21 =
	gtk_toolbar_append_element (GTK_TOOLBAR (toolbar3),
	GTK_TOOLBAR_CHILD_BUTTON, NULL, _("Up"), NULL, NULL, tmp_toolbar_icon,
	NULL, NULL);
    ...
    tmp_toolbar_icon =
	gnome_stock_pixmap_widget (Rules, GNOME_STOCK_PIXMAP_DOWN);
    button22 =
	gtk_toolbar_append_element (GTK_TOOLBAR (toolbar3),
	GTK_TOOLBAR_CHILD_BUTTON, NULL, _("Down"), NULL, NULL,
	tmp_toolbar_icon, NULL, NULL);
    ...
    gtk_object_set_data_full (GTK_OBJECT (Rules), "rule_new_rule",
	rule_new_rule, (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data (GTK_OBJECT (Rules), "dialog_action_area3",
	dialog_action_area3);
    ...
    gnome_dialog_append_button (GNOME_DIALOG (Rules),
	GNOME_STOCK_BUTTON_APPLY);
...
create_custom_mbox (void)
{
    ...
    gtk_object_set_data (GTK_OBJECT (custom_mbox), "dialog_vbox4",
	dialog_vbox4);
    ...
    gtk_object_set_data_full (GTK_OBJECT (custom_mbox),
	"mbox_create_custom_name", mbox_create_custom_name,
	(GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (custom_mbox),
	"mbox_create_custom_query", mbox_create_custom_query,
	(GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data (GTK_OBJECT (custom_mbox), "dialog_action_area4",
	dialog_action_area4);
    ...
    gnome_dialog_append_button (GNOME_DIALOG (custom_mbox),
	GNOME_STOCK_BUTTON_OK);
    button23 =
	GTK_WIDGET (g_list_last (GNOME_DIALOG (custom_mbox)->buttons)->data);
	...
	GTK_SIGNAL_FUNC (on_mboxcustomok_clicked), NULL);
    gtk_signal_connect (GTK_OBJECT (button24), "clicked",
	GTK_SIGNAL_FUNC (on_mboxcustomapply_clicked), NULL);
    gtk_signal_connect (GTK_OBJECT (button25), "clicked",
	GTK_SIGNAL_FUNC (on_mboxcustomcancel_clicked), NULL);
