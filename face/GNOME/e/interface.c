...
/*
 * $Id: interface.c,v 1.5 2007/02/12 19:26:33 erik Exp $
 */
...
create_gems (void)
{
    ...
    tmp_toolbar_icon =
	gnome_stock_pixmap_widget (gems, GNOME_STOCK_PIXMAP_MAIL_NEW);
    button5 =
	gtk_toolbar_append_element (GTK_TOOLBAR (toolbar1),
				    GTK_TOOLBAR_CHILD_BUTTON, NULL,
				    _("Compose"), _("Compose new"), NULL,
				    tmp_toolbar_icon, NULL, NULL);
    ...
    tmp_toolbar_icon =
	gnome_stock_pixmap_widget (gems, GNOME_STOCK_PIXMAP_BACK);
    button8 =
	gtk_toolbar_append_element (GTK_TOOLBAR (toolbar1),
				    GTK_TOOLBAR_CHILD_BUTTON, NULL,
				    _("Previous"), _("Previous Mail"), NULL,
				    tmp_toolbar_icon, NULL, NULL);
    ...
    tmp_toolbar_icon =
	gnome_stock_pixmap_widget (gems, GNOME_STOCK_PIXMAP_FORWARD);
    button9 =
	gtk_toolbar_append_element (GTK_TOOLBAR (toolbar1),
				    GTK_TOOLBAR_CHILD_BUTTON, NULL, _("Next"),
				    _("Next mail"), NULL, tmp_toolbar_icon,
				    NULL, NULL);
    ...
    tmp_toolbar_icon =
	gnome_stock_pixmap_widget (gems, GNOME_STOCK_PIXMAP_ATTACH);
    button13 =
	gtk_toolbar_append_element (GTK_TOOLBAR (toolbar1),
				    GTK_TOOLBAR_CHILD_BUTTON, NULL,
				    _("Attach"), _("Attach"), NULL,
				    tmp_toolbar_icon, NULL, NULL);
    ...
    tmp_toolbar_icon =
	gnome_stock_pixmap_widget (gems, GNOME_STOCK_PIXMAP_BOOK_BLUE);
    button12 =
	gtk_toolbar_append_element (GTK_TOOLBAR (toolbar1),
				    GTK_TOOLBAR_CHILD_BUTTON, NULL,
				    _("Address"), _("AddressBook"), NULL,
				    tmp_toolbar_icon, NULL, NULL);
	...
	gtk_toolbar_append_element (GTK_TOOLBAR (toolbar1),
				    ...
				    _("Help"), NULL, tmp_toolbar_icon, NULL,
				    NULL);
    ...
    gtk_signal_connect (GTK_OBJECT (button1), "clicked",
			GTK_SIGNAL_FUNC (on_trash_clicked), NULL);
    gtk_signal_connect (GTK_OBJECT (button4), "clicked",
			GTK_SIGNAL_FUNC (on_check_clicked), NULL);
    gtk_signal_connect (GTK_OBJECT (button5), "clicked",
			GTK_SIGNAL_FUNC (on_compose_clicked), NULL);
    gtk_signal_connect (GTK_OBJECT (button6), "clicked",
			GTK_SIGNAL_FUNC (on_reply_clicked), NULL);
    gtk_signal_connect (GTK_OBJECT (button14), "clicked",
			GTK_SIGNAL_FUNC (on_forward_clicked), NULL);
    gtk_signal_connect (GTK_OBJECT (button8), "clicked",
			GTK_SIGNAL_FUNC (on_prev_clicked), NULL);
    gtk_signal_connect (GTK_OBJECT (button9), "clicked",
			GTK_SIGNAL_FUNC (on_next_clicked), NULL);
    gtk_signal_connect (GTK_OBJECT (button13), "clicked",
			GTK_SIGNAL_FUNC (on_attach_clicked), NULL);
    gtk_signal_connect (GTK_OBJECT (button12), "clicked",
			GTK_SIGNAL_FUNC (on_addr_clicked), NULL);
    ...
    gtk_signal_connect (GTK_OBJECT (button10), "clicked",
			GTK_SIGNAL_FUNC (on_help_clicked), NULL);
    gtk_signal_connect (GTK_OBJECT (tree1), "select_child",
			GTK_SIGNAL_FUNC (on_tree1_select_child), NULL);
...
create_about2 (void)
{
    ...
    about2 = gnome_about_new ("gems", VERSION,
			      _("Copyright (C) 2000-2007 Erik Greenwald"),
...
create_propertybox1 (void)
{
    ...
    gtk_object_set_data (GTK_OBJECT (propertybox1), "propertybox1",
			 propertybox1);
    ...
    gtk_object_set_data_full (GTK_OBJECT (propertybox1), "optionmenu1",
			      optionmenu1,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (propertybox1), "optionmenu2",
			      optionmenu2,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (propertybox1), "scrolledwindow3",
			      scrolledwindow3,
			      (GtkDestroyNotify) gtk_widget_unref);
...
create_readbox (void)
{
    ...
    gtk_object_set_data_full (GTK_OBJECT (readbox), "scrolledwindow4",
			      scrolledwindow4,
			      (GtkDestroyNotify) gtk_widget_unref);
...
create_vbox2 (void)
{
    ...
    tmp_toolbar_icon =
	gnome_stock_pixmap_widget (vbox2, GNOME_STOCK_PIXMAP_PROPERTIES);
    pgpsign =
	gtk_toolbar_append_element (GTK_TOOLBAR (toolbar2),
				    GTK_TOOLBAR_CHILD_BUTTON, NULL,
				    _("PGP sign"), _("PGP Sign"), NULL,
				    tmp_toolbar_icon, NULL, NULL);
    ...
    tmp_toolbar_icon =
	gnome_stock_pixmap_widget (vbox2, GNOME_STOCK_PIXMAP_SPELLCHECK);
    splchk =
	gtk_toolbar_append_element (GTK_TOOLBAR (toolbar2),
				    GTK_TOOLBAR_CHILD_BUTTON, NULL,
				    _("Spellcheck"), _("Spellcheck"), NULL,
				    tmp_toolbar_icon, NULL, NULL);
    ...
    tmp_toolbar_icon =
	gnome_stock_pixmap_widget (vbox2, GNOME_STOCK_PIXMAP_MAIL_SND);
    snd =
	gtk_toolbar_append_element (GTK_TOOLBAR (toolbar2),
				    GTK_TOOLBAR_CHILD_BUTTON, NULL, _("Send"),
				    _("Send"), NULL, tmp_toolbar_icon, NULL,
				    NULL);
    gtk_widget_ref (snd);
    ...
    gtk_object_set_data_full (GTK_OBJECT (vbox2), "combo_entry1",
			      combo_entry1,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (vbox2), "combo_entry2",
			      combo_entry2,
			      (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (vbox2), "scrolledwindow5",
			      scrolledwindow5,
			      (GtkDestroyNotify) gtk_widget_unref);
...
create_scrolledwindow6 (void)
{
    ...
    gtk_object_set_data (GTK_OBJECT (scrolledwindow6), "scrolledwindow6",
			 scrolledwindow6);
    ...
    gtk_object_set_data_full (GTK_OBJECT (scrolledwindow6), "label23",
			      label23, (GtkDestroyNotify) gtk_widget_unref);
    gtk_widget_show (label23);
    gtk_clist_set_column_widget (GTK_CLIST (Date), 0, label23);

    label24 = gtk_label_new (_("Date\t"));
    gtk_widget_ref (label24);
    gtk_object_set_data_full (GTK_OBJECT (scrolledwindow6), "label24",
			      label24, (GtkDestroyNotify) gtk_widget_unref);
    gtk_widget_show (label24);
    gtk_clist_set_column_widget (GTK_CLIST (Date), 1, label24);

    label25 = gtk_label_new (_("Subject"));
    gtk_widget_ref (label25);
    gtk_object_set_data_full (GTK_OBJECT (scrolledwindow6), "label25",
			      label25, (GtkDestroyNotify) gtk_widget_unref);
    gtk_widget_show (label25);
    gtk_clist_set_column_widget (GTK_CLIST (Date), 2, label25);

    gtk_signal_connect (GTK_OBJECT (Date), "event",
			GTK_SIGNAL_FUNC (on_clist_event), NULL);
...
create_dummywindow (void)
{
    ...
    gtk_object_set_data (GTK_OBJECT (dummywindow), "dummywindow",
			 dummywindow);
